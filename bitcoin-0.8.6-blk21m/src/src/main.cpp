...
// Chino Ltd Internal Genesis Block
uint256 hashGenesisBlock("0x00000000e6069fcd58d2343cadf2088de788f2c67dfd9b4c17452bfac876de2d");
...
static const int64 nTargetTimespan =  12 * 60 * 60; // Every hour
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    /* Removed this because it might block transactions 
    ...
    if (hash != hashGenesisBlock) {
        ...
        if (!Checkpoints::CheckBlock(nHeight, hash))
            return state.DoS(100, error("AcceptBlock() : rejected by checkpoint lock-in at %d", nHeight));
				...
				/*** REMOVE ALL THE CHECK ON BLOCK VERSION ***/
				// Will figure out another day what miner to use.
				// - Theo - Sep 25, 2015
...
//        const char* pszTimestamp = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
        ...
        block.nVersion = 1;
        block.nTime    = 1427071774;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 1046012911;
